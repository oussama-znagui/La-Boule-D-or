...
public class individualTournamentRequestDTO extends TournamentRequestDTO {
    ...
    public individualTournamentRequestDTO(String title, TournamentType type, int numberOfPlayers, LocalDate startDate, LocalDate endDate, String rules, String prize, TounamentMode mode, Long hostingClub_id) {
