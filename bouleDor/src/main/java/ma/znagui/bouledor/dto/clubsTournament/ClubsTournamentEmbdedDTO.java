...
public class ClubsTournamentEmbdedDTO extends TournamentEmbdedDTO {
    ...
    public ClubsTournamentEmbdedDTO(Long id, String title, TournamentType type, int numberOfPlayers, LocalDate startDate, LocalDate endDate, String rules, String prize, TournrmrntStatus status, TounamentMode mode, TournamentFormat format, ClubEmbdedDTO hostingClub,int numberOfTeams) {
