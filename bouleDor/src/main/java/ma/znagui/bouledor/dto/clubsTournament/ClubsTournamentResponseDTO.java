...
public class ClubsTournamentResponseDTO  extends TournamentResponseDTO {
    ...
    public ClubsTournamentResponseDTO(Long id, String title, TournamentType type, int numberOfPlayers, LocalDate startDate, LocalDate endDate, String rules, String prize, TournrmrntStatus status, TounamentMode mode, ClubEmbdedDTO hostingClub, List<TournamentPlayersEmbdedDTO> players,int numberOfTeams) {
        super(id, title, type, numberOfPlayers, startDate, endDate, rules, prize, status, mode, hostingClub, players);
